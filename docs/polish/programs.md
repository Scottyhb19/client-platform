...
- **Visual walkthrough** — pending. The preview agent's session is unauthenticated; the user verifies in their browser by refreshing their existing `/clients/{id}/program` tab.
