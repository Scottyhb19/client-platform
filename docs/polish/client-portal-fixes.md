...
| **Bug #5** | New migration `20260510130100_client_complete_session_v2.sql`. RPE guard flipped to `IS NOT NULL AND NOT BETWEEN 1 AND 10` — only validates range when supplied. | [Migration](../../supabase/migrations/20260510130100_client_complete_session_v2.sql) |
