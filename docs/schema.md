...
- `client_medications` (added 2026-07-02, migration `20260702180000` — parity with CN-6; the sibling clone carried the identical last-write-wins property; pgTAP `55`)
